    ...
    <div class="col-md-12">
        <div class="card border-0 mb-4 no-bg">
            <div class="card-header py-3 px-0 d-flex align-items-center  justify-content-between border-bottom">
                <h3 class=" fw-bold flex-fill mb-0">회원관리</h3>
            </div>
        </div>
    </div>
</div><!-- Row End -->
                ...
                <div class="card teacher-card">
                    <div class="card-body  d-flex">
                        <div class="profile-av pe-xl-4 pe-md-2 pe-sm-4 pe-4 text-center w220">
                            <img width="200" height="200" src="${cPath}/resources/images/lg/마스코트_투명.png" alt="" class="avatar xl rounded-circle img-thumbnail shadow-sm">
                        ...
                        <div class="teacher-info border-start ps-xl-4 ps-md-3 ps-sm-4 ps-4 w-100">
                            ...
                            <span class="py-1 fw-bold small-11 mb-0 mt-1 text-muted">\${item.memberGrade}</span>
