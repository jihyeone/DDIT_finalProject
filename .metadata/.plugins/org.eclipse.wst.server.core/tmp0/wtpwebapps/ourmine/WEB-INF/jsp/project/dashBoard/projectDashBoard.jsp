	...
	<div class="col-xxl-4 col-xl-4 col-lg-4 col-md-12">
		  <div class="card">
		      <div class="card-header py-3">
		          <h6 class="mb-0 fw-bold ">프로젝트참여인원</h6>
		      </div>
		      <div class="card-body">
		...
		<div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
		 ...
		 <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
		    <div class="card">
		        <div class="card-header py-3">
		            <h6 class="mb-0 fw-bold ">담당자별 일감 진척도 </h6>
		        </div>
					...
					proData.innerHTML +=
						...
						<div class="py-2 d-flex align-items-center border-bottom">
		                  <div class="d-flex ms-2 align-items-center flex-fill">
		                      <img src="${cPath}/resources/images/xs/마스코트_투명.png" class="avatar lg rounded-circle img-thumbnail" alt="avatar">
					...
					if(firstData){
						issueHeader.innerHTML +=
							...
							<div class="d-flex align-items-center">
									...
									<a href="/ourmine/company/\${companyIdHiddenValue}/project/\${projectIdHiddenValue}/projectIssue" title="space-used" class="btn btn-link text-decoration-none  rounded-1"><i class="icofont-hand-drawn-right fs-2 "></i></a>
							</div>
								<div id="apex-circle-chart2"></div>
								<div class="timesheet-info d-flex align-items-center justify-content-around flex-wrap">

									<div class="intime d-flex align-items-center">
										<i class="icofont-bell-alt fs-4 color-light-success"></i>
		...
		params: {
			...
			.then(resp => {
				...
				workHeader.innerHTML+=
                    ...
                    <a href="/ourmine/company/\${companyIdHiddenValue}/project/\${projectIdHiddenValue}/projectWork" title="renewal-date" class="btn btn-link text-decoration-none  rounded-1"><i class="icofont-hand-drawn-right fs-2 "></i></a>
                </div>
                <div id="apex-circle-chart3"></div>
	            <div class="timesheet-info d-flex align-items-center justify-content-around flex-wrap">
	                <div class="intime d-flex align-items-center">
	                    <i class="icofont-file-alt fs-3 color-lavender-purple"></i>
	                    <span class="fw-bold ms-1">진행:\${data.startedCount} </span>
	                </div>
	                <div class="intime d-flex align-items-center">
	                    <i class="icofont-file-alt fs-4 color-light-success"></i>
