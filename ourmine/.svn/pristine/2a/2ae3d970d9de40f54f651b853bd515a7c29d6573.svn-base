...
<div id="mytask-layout" class="theme-indigo">
    ...
    <div class="main">
        <!-- Body: Body -->
        <div class="body d-flex ms-4">
            <div class="m-4">
                <div class="row g-0">
                    <div class="col-10 d-flex ms-4">
                       <!-- Card: -->
                        <div class="card card-chat border-right border-top-0 border-bottom-0  w420" id="searchCard">
                        <button type="button" class="btn btn-dark btn-set-task w-sm-100" data-bs-toggle="modal" data-bs-target="#createtask"><i class="icofont-plus-circle me-2 fs-6"></i>채팅방 만들기</button>
                            <div class="px-4 py-3 py-md-4">
                                ...
                                <div class="nav nav-pills justify-content-between text-center" role="tablist" id="reloadList">
                        ...
                        <div class="card card-chat-body border-0  w-100 px-4 px-md-5 py-3 py-md-4">
                            ...
                            <div class="chat-header d-flex justify-content-between align-items-center border-bottom pb-3">
                                <div class="d-flex align-items-center">
                                    <a href="/ourmine/company/1/project/4/dashBoard" title="Home"><i class="fa fa-home fs-5"></i></a>
		              ...
		              chatListArea.append(
						...
						`<ul class="list-unstyled list-group list-group-custom list-group-flush mb-0 searchChatList">
		                  <li class="list-group-item px-md-4 py-3 py-md-4 wsControl useMemberRoom" data-room="\${resp[i].chattingId}" data-roomname="\${resp[i].chattingMemName}" data-contenttime="\${resp[i].chattingContentTime}" data-role="connect">
		                      <a href="javascript:void(0);" class="d-flex">
		                          <img class="avatar rounded-circle" src="${cPath}/resources/images/xs/avatar7.jpg" alt="">
		                          <div class="flex-fill ms-3 text-truncate">
		                              <h6 class="d-flex justify-content-between mb-0">
	          ...
	          success:function(resp){
	              ...
	              for(let i=0; i<resp.length; i++){
	            	  chatGroupListArea.append(
						`
						<ul class="list-unstyled list-group list-group-custom list-group-flush mb-0 searchChatList">
		                  <li class="list-group-item px-md-4 py-3 py-md-4 wsControl" data-room="\${resp[i].chattingId}" data-roomname="\${resp[i].chattingName}" data-contenttime="\${resp[i].chattingContentTime}" data-role="connect">
		                      <a href="javascript:void(0);" class="d-flex">
		                          <img class="avatar rounded-circle" src="${cPath}/resources/images/sm/마스코트_투명.png" alt="">
		                          <div class="flex-fill ms-3 mt-2 text-truncate">
		                              <h6 class="d-flex justify-content-between mb-0 searchChatTarget"><span>\${resp[i].chattingName}</span> <small class="msg-time">\${resp[i].chattingContentTime}</small></h6>
		                          </div>
		                      </a>
                              <div class="d-flex justify-content-between mb-0" style="width:100%">
                         		<span class="text-muted">\${resp[i].chattingContent}</span>
