...
public class OrgchartServiceImpl implements OrgchartService{
	...
	@Override
	public int orgchartMemberInsert(List<OrgchartVO> orgchart) {
	...
	@Override
	public List<OrgchartVO> orgchartSelectMemberList(OrgchartVO orgchart) {
		
		return orgchartDAO.orgchartSelectMemberList(orgchart);
	}

	@Override
	public List<OrgchartVO> orgchartSeniorList(OrgchartVO orgchart) {
		return orgchartDAO.orgchartSeniorList(orgchart);
	}

	@Override
	public int orgchartSeniorUpdate(OrgchartVO orgchart) {
		return orgchartDAO.orgchartSeniorUpdate(orgchart);
	}
