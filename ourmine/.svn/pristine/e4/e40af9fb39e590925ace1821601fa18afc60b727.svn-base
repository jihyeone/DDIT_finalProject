                            ...
                            <form id="frmRegist" class="row g-1 p-3 p-md-4" onsubmit="handleSubmit(event)">
                                ...
                                <div class="col-12">
                                    <div class="mb-2">
                                        ...
                                        <input id="companyName2" name="companyName" type="text" class="form-control form-control-lg" placeholder="주(삼성전자)" />
                                ...
                                <div class="col-12">
                                    <div class="mb-2">
                                        ...
                                        <input type="text"  id="sample6_address" class="form-control form-control-lg companyAddr2" name="companyAddr" placeholder="대전광역시 중구 오류동" required>
                                ...
                                <div class="col-12">
                                    <div class="mb-2">
                                        ...
                                        <input name="companyTel" type="tel" class="form-control form-control-lg companyTel2" placeholder="042-628-0452" />
                                ...
                                <div class="col-12 text-center mt-4">
                                    ...
                                    <button type="button" class="btn btn-lg btn-block btn-light lift text-uppercase" alt="SIGNUP" id="btn">자동완성</button>
                                </div>
                            </form>
                            <!-- End Form -->
                        </div>
...
<script>
    ...
    let companyName2 = document.querySelector('#companyName2');
    let companyAddr2 = document.querySelector('.companyAddr2');
    let companyTel2 = document.querySelector('.companyTel2');
    let isCheck = false
	...
	btn.addEventListener('click', () => {
		companyName2.value = '(주)송림전자';
		companyAddr2.value = '대전광역시 중구 오류동 732';
		companyTel2.value = '042-222-8145';
    })
