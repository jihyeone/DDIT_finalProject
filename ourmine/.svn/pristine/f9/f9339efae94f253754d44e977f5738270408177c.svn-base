...
public class CompanyServiceImpl implements CompanyService{
	...
	public List<CompanyVO> companyMember(CompanyVO company) {
		int count =  companyDAO.requstStatusCount(company);
		
		List<CompanyVO> compnayList =  companyDAO.companyMember(company);
		compnayList.forEach(item -> item.setTotalData(count));
		return compnayList;
	}
	...
	public List<CompanyVO> requstStatusOption() {
		...
		return companyDAO.requstStatusOption();
	}
