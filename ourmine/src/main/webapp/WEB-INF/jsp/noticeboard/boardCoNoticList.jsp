			...
			<form name="jiModifyForm" id="jiModifyForm"
				...
				<div class="modal-content">
					...
					<textarea name="boardContent" class="form-control"
						id="boardContentTextArea" required></textarea>
				</div>
			</form>
		</div>
		...
		<div class="modal-content card mb-3" id="selectContent">
			...
			<div class="card-body">
				<div class="row g-3 align-items-center">
					<div class="col-md-12">
						<div class="form-group">
							<label>글제목</label> <input type="text" id="boardTitle"
								name="boardTitle" class="form-control" disabled> <input
								type="hidden" id="noticeBoardWriteId" name="noticeBoardWriteId"
								class="form-control">
						</div>
					</div>
					<div class="form-group">
						<label>게시글번호</label> <input type="text" id="boardId"
							name="boardId" class="form-control" disabled> <input
							type="hidden" id="noticeBoardWriteId" name="noticeBoardWriteId"
							class="form-control">
					</div>
				</div>
				<div class="col-md-12">
					<div class="form-group">
						<label>분류</label> <input type="text" id="category" name="category"
							class="form-control" value="사내공지" disabled>
					</div>
				</div>
				<div class="col-md-12">
					<div class="form-group">
						<label>작성자</label> <input type="text" id="boardWriter"
							name="boardWriter" class="form-control" disabled>
					</div>
				</div>
				<div class="col-md-12">
					<div class="form-group">
						<label>작성일자</label> <input type="text" id="boardWriteDate"
							name="boardWriteDate" class="form-control" disabled>
					</div>
				</div>
				<div class="col-md-12">
					<div class="form-group">
						<label>조회수</label> <input type="text" id="boardCount"
							name="boardCount" class="form-control" disabled>
					</div>
				</div>
				<div class="col-md-12">
					<div class="form-group">
						...
						<textarea id="boardContent" name="boardContent"
							class="form-control" rows="5" cols="30" disabled></textarea>
					</div>
				</div>
				<div class="col-md-12">
					<div class="form-group">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-secondary"
					onclick="coNoSeModalClose()">닫기</button>
...
<input type="text" class="form-control" oninput="onQuickFilterChanged()"
	id="quickFilter" placeholder="검색..." />
<br>
