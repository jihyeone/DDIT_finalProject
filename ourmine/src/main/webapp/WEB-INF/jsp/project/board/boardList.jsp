...
<script type="text/javascript">
	const autoReply = () => {
		var replyInput = document.getElementById("replyContentVal");
		replyInput.value = "참여하고 싶습니다~";
	}
</script>
...
<div id="jiModal">
	<div id="jiContent">
		...
		<section class="mb-5" id="reply">
			<div class="card bg-light">
				<div class="card-body">
					<button type="button" class="btn" style="color:gray; float: right;" onclick="autoReply()">자동완성</button>
					<!-- Comment form-->
					<form class="mb-4" name="insertReplyForm" id="insertReplyForm"
						...
						<input id="boardId1" name="boardId" type="hidden" /> <input
							...
							name="replyContent" id="replyContentVal" style="width: 100%;" />
						<div id="janeError" style="display:none;color:red" >댓글을 입력해 주세요!</div>
					</form>
					<button type="button"
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1"
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalCenterTitle">게시판 추가</h5>
			...
			<div class="card mb-3">
				...
				<div class="card-body">
					<form onsubmit="handleSubmit(event)" novalidate="novalidate"
						...
						<div class="modal-footer">
							<button type="button" class="btn" style="color:gray;" onclick="autoBoard()">자동완성</button>
	...
	<div class="container-xxl">
		<div class="row align-items-center">
				...
				<div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
					...
					<div class="col-auto d-flex w-sm-100">
						...
						<button type="button"
							...
							id="boardTypeDelBtn">
							<i class="icofont-minus-circle me-2 fs-6"></i> 게시판 제거
						</button>
			...
			<div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
				...
				<div class="col-auto d-flex w-sm-100">
					<button type="button"
						class="btn btn-dark btn-set-task w-sm-100 m-1 mx-3" id="boardAddBtn"
...
// 	              console.log("결과확인",resp);  // 요기 코드가 길어지면  별도 함수로 처리/ 그래야 가독성이 유지됨
        ...
        // =========== 그룹 채팅방 이름 공란에러메세지 ==============
		$("#replyContentVal").on("keyup",function(){
			if(this.value.trim().length){
				$("#janeError").css("display","none");
			}
		})
...
//                     { field: "boardTypeId", headerName: "게시판종류", cellStyle: {textAlign: 'center'}, maxWidth: 100 },
		...
		const autoBoard = () =>{
			let autoBoardTitle = document.querySelector("#boardTitleClear");
			let autoBoardContent = document.querySelector("#boardContentClear");
			
			autoBoardTitle.value="토요일마다 함께 자바스크립트 공부하실분 모집합니다.";
			autoBoardContent.value="토요일마다 함께 자바스크립트 공부하실분 댓글남겨주시면 단톡방 초대드리겠습니다~!^^";
		}
