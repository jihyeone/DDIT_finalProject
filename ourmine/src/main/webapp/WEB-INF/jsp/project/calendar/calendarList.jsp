	                            ...
	                            $(function () {
	                                ...
	                                calendar = new Calendar(calendarEl, {
	                                   ...
	                                   eventDrop: function (info) {    // 드래그해서 위치 지정하면 날짜 수정
											...
											let offsetE = y.getTimezoneOffset() * 60000; //ms단위라 60000곱해줌
											
											let dateOffset = new Date(x.getTime() - offset);
											let dateOffsetE = new Date(y.getTime() - offsetE);
	                                	   
	                                        let data = {
	                                        		projectWorkId:info.event.extendedProps.projectWorkId,
	                                        		projectWorkStartDate:dateOffset.toISOString().substr(0, 10),
	                                        		projectWorkEndDate:y.toISOString().substr(0, 10)
	                                        	};
	                                        console.log("data@@@@@@@@",data);

	                                        $.ajax({
	                                            url: "/ourmine/company/${companyId}/project/${projectId}/calendar/calUpdateDrag",
	                                            type: "post",
	                                    ...
	                                    eventClick: function caClick(info) {
											...
											let dateOffset = new Date(x.getTime() - offset);
											let dateOffsetE = new Date(y.getTime() - offsetE);
											console.log("dateOffsetE",dateOffsetE);
	                                        ...
	                                        $("#start").val(dateOffset.toISOString().substr(0, 10));
	                                        $("#end").val(y.toISOString().substr(0, 10));
                ...
                <div id="modifyModalCont" class="modifyModalCont">
                	...
                	<form name="modifyForm" id="modifyForm" novalidate>
	                    ...
	                    <hr>
		                    ...
		                    <br>
		                    <i class="icofont-page"></i> <label for="exampleFormControlTextarea786" class="form-label">내용</label>		                    <textarea class="form-control"  id="projectWorkContent1" name="projectWorkContent"  type="text"  rows="3" ></textarea>
		                    <br>
		                    <div class="modal-footer">
...
// 모달창에서 일정 수정하기
const caModifyModal = $(".modifyModal");
