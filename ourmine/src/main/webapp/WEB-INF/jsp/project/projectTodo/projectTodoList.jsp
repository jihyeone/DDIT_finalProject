...
<script type="text/javascript">
	const autoTodo1 = () => {
		...
		todoTitleInput.value = "코드게시판";
		var todoContentInput = document.getElementById("todoContent");
		todoContentInput.value = "코드오류 이슈 확인 후 코드 수정/등록";
	}
	const autoTodo2 = () => {
		var todoTitleInput = document.getElementById("todoTitle");
		todoTitleInput.value = "코드게시판";
		var todoContentInput = document.getElementById("todoContent");
		todoContentInput.value = "공통으로 사용하는 모달 코드를 올리기";
	}
</script>
	            ...
	            <div class="modal-dialog modal-dialog-centered modal-md modal-dialog-scrollable">
	                <div class="modal-content">
	                    ...
	                    <div class="modal-footer">
	                    	<button type="button" class="btn" style="color:gray;" onclick="autoTodo1()">자동완성1</button>
	                        <button type="button" class="btn" style="color:gray;" onclick="autoTodo2()">자동완성2</button>
...
// <!-- ================================================================================================= -->
	...
	$(document).on("click", ".completeButton", function(){
		...
		let mypwList = document.querySelector('#mypwList');
		...
		axios.post(`/ourmine/company/\${companyIdHiddenValue}/project/\${projectIdHiddenValue}/projectTodoList/updateStatus`, workId, {headers: headers})
			.then(resp => {
				...
				mypwList.innerHTML=''; // mypwList 목록 비우기
				todoDivHidden();
				projectWorkList();
			})
			.catch(error => {
...
// <!-- ================================================================================================= -->	
	...
	async function projectWorkList() {
	    ...
	    await axios.get(`/ourmine/company/${companyId}/project/${projectId}/projectTodoList/projectWorkList`, {headers: headers})
            .then(resp => {
                let data = resp.data;
...
//                 mypwList.innerHTML = '';
                ...
                mypwList.innerHTML += data.map(item => 
                    `
				...
				pageLinks.forEach((link, index) => {
					link.addEventListener('click', function(event){
						...
						axios.get(`/ourmine/company/\${companyIdHiddenValue}/project/\${projectIdHiddenValue}/projectTodoList/projectWorkList`,{
							params: {
								page: pageNumber
							}
						},{headers : headers})
...
// <!-- =============================================================================================== -->
	...
	searchProjectWork.addEventListener('input', () => {
		...
		let mypwList = document.getElementById('mypwList');
