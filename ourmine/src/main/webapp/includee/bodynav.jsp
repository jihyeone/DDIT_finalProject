...
<div>
	...
	<ul class="nav nav-tabs tab-card" role="tablist">
	    <li class="nav-item"><a class="nav-link" href="/ourmine/company/${companyId}/project/${projectId}/dashBoard">대시보드</a></li>
	    ...
	    <li class="nav-item"><a class="nav-link" href="/ourmine/company/${companyId}/project/${projectId}/git/gitList">GITHUB</a></li>
		<li class="nav-item" >
			<select name="jidisp" class="dropdown-item py-2 rounded nav-link" style="border:none;position:relative;" id="jidisp" onchange="fselChange(this)">
				<option value="0" class="dropdown-item py-2 rounded" selected>게시판</option>
			</select>
	    </li>
	</ul>
</div>
